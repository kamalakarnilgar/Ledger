...
The search script is installed at `.claude/skills/ui-ux-pro-max/scripts/search.py`, relative to the repository root. Always invoke it by that path — do not assume a different working directory:
